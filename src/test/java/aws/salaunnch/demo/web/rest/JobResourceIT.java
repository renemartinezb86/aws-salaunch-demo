...
public class JobResourceIT {
     ...
     *
     * @see aws.salaunnch.demo.repository.search.JobSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createJob() throws Exception {
        ...
        assertThat(testJob.getSpecialty()).isEqualTo(DEFAULT_SPECIALTY);
    ...
    public void getAllJobsWithEagerRelationshipsIsEnabled() throws Exception {
        JobResource jobResource = new JobResource(jobRepositoryMock, mockJobSearchRepository);
    ...
    public void updateJob() throws Exception {
        ...
        assertThat(testJob.getSpecialty()).isEqualTo(UPDATED_SPECIALTY);

...
import aws.salaunnch.demo.domain.Location;
import aws.salaunnch.demo.service.LocationService;
...
/**
 * REST controller for managing {@link aws.salaunnch.demo.domain.Location}.
 */
@RestController
@RequestMapping("/api")
public class LocationResource {
    ...
    private static final String ENTITY_NAME = "awSsaLaunchLocation";

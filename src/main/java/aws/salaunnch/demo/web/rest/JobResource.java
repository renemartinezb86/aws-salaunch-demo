...
import aws.salaunnch.demo.repository.JobRepository;
import aws.salaunnch.demo.repository.search.JobSearchRepository;
...
/**
 * REST controller for managing {@link aws.salaunnch.demo.domain.Job}.
 */
@RestController
@RequestMapping("/api")
public class JobResource {
    ...
    private static final String ENTITY_NAME = "awSsaLaunchJob";
    ...
    public ResponseEntity<List<Job>> searchJobs(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
